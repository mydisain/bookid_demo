            ...
            <form action="{{ route('admin.services.save') }}" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Teenuse nimetus" name="name"  id="name"/>
                    </div>
                    <div class="form-group">
                        <label for="selectDefault">Kirjeldus</label>
                        <textarea class="form-control" placeholder="Teenuse kirjeldus" name="description" id="description" cols="30" rows="10"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="defaultInput">Kestvus(min)</label>
                        <input class="form-control" type="text" placeholder="Teenuse kestvus minutites" name="duration"  id="duration"/>
                    </div>
                    <div class="form-group">
                        <label for="defaultInput">Hind(€)</label>
                        <input class="form-control" type="text" placeholder="Hind eurodes" name="price"  id="price"/>
                    </div>
                </div>
