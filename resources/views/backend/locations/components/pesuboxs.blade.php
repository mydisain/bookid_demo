  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Asukoha töötajad</h4>
          ...
          <form id="edit_pesubox_form">
              ...
              <div class="modal-body">
                  <div class="form-group">
                      ...
                      <input class="form-control" type="text" placeholder="Töötaja nimi" name="name"  id="name"/>
                  </div>
              </div>
              <div class="modal-body">
                <div class="form-group">
                    <label for="defaultInput">Amet</label>
                    <textarea class="form-control" type="text" placeholder="Töötaja amet" name="description"  id="description"></textarea>
                </div>
              </div>
